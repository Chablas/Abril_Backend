...
public interface IPenalidadNotificationService
{
    ...
    Task NotificarDescargoAlContratistaAsync(PenalidadDetalleDto p, List<string> contratistaEmails);

    /// <summary>Recordatorio al contratista antes de vencer el plazo de descargo.</summary>
    Task RecordatorioDescargoAsync(PenalidadDetalleDto p, List<string> contratistaEmails);
    ...
    Task NotificarDecisionFinalAsync(PenalidadDetalleDto p, List<string> contratistaEmails);
